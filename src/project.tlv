   ...
   TLV_fn(riscv_sum_prog, {
      ~assemble(['
         ...
         # Function:
            ...
            jal x0, 8
            SW x10, 4(x0)
            LW x15, 4(x0)# Initialize intermediate sum register a3 with 0
         loop:
...
\TLV cpu()
   ...
   |cpu
      ...
      @1
         ...
         $is_load = $dec_bits[6:2] == 5'b00000;
         
         
         
      @2   // Note that pipesignals assigned here can be found under /fpga_pins/fpga.
      ...
      @3
         ...
         $rf_wr_en = ($valid && ($rd_valid && ($rd != 5'b00000)))||>>2$valid_load;
